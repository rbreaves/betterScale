...
main() {
    ...
    echo ""
    echo "5% scale increments"
    echo "-----------------"
    echo " 0:  50%: "$((${res0_width%.*}/2))"x"$((${res0_height%.*}/2))
    echo " 1:  55%: "$((${res1_width%.*}/2))"x"$((${res1_height%.*}/2))
    echo " 2:  60%: "$((${res2_width%.*}/2))"x"$((${res2_height%.*}/2))
    echo " 3:  65%: "$((${res3_width%.*}/2))"x"$((${res3_height%.*}/2))
    echo " 4:  70%: "$((${res4_width%.*}/2))"x"$((${res4_height%.*}/2))
    echo " 5:  75%: "$((${res5_width%.*}/2))"x"$((${res5_height%.*}/2))
    echo " 6:  80%: "$((${res6_width%.*}/2))"x"$((${res6_height%.*}/2))
    echo " 7:  85%: "$((${res7_width%.*}/2))"x"$((${res7_height%.*}/2))
    echo " 8:  90%: "$((${res8_width%.*}/2))"x"$((${res8_height%.*}/2))
    echo " 9:  95%: "$((${res9_width%.*}/2))"x"$((${res9_height%.*}/2))
    echo "10: 100%: "$((${res10_width%.*}/2))"x"$((${res10_height%.*}/2))

    echo ""
    echo "In between quarter scales"
    echo "-----------------"
    echo "11: Scale 62.5%: "$((${resq1_width%.*}/2))"x"$((${resq1_height%.*}/2))
    echo "12: Scale 87.5%: "$((${resq3_width%.*}/2))"x"$((${resq3_height%.*}/2))
    echo ""
    ...
    0)
        echo "Applying 50%: "$((${res0_width%.*}/2))"x"$((${res0_height%.*}/2))
        ...
        ;;
    1)
        echo "Applying 55%: "$((${res1_width%.*}/2))"x"$((${res1_height%.*}/2))
        ...
        ;;
    2)
        echo "Applying 60%: "$((${res2_width%.*}/2))"x"$((${res2_height%.*}/2))
        ...
        ;;
    3)
        echo "Applying 65%: "$((${res3_width%.*}/2))"x"$((${res3_height%.*}/2))
        ...
        ;;
    4)
        echo "Applying 70%: "$((${res4_width%.*}/2))"x"$((${res4_height%.*}/2))
        ...
        ;;
    5)
        echo "Applying 75%: "$((${res5_width%.*}/2))"x"$((${res5_height%.*}/2))
        ...
        ;;
    6)
        echo "Applying 80%: "$((${res6_width%.*}/2))"x"$((${res6_height%.*}/2))
        ...
        ;;
    7)
        echo "Applying 85%: "$((${res7_width%.*}/2))"x"$((${res7_height%.*}/2))
        ...
        ;;
    8)
        echo "Applying 90%: "$((${res8_width%.*}/2))"x"$((${res8_height%.*}/2))
        ...
        ;;
    9)
        echo "Applying 95%: "$((${res9_width%.*}/2))"x"$((${res9_height%.*}/2))
